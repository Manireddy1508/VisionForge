...
def create_collection():
    ...
    try:
        ...
        fields = [
            ...
            FieldSchema(name="enhanced_prompt", dtype=DataType.VARCHAR, max_length=2000),
...
def search_similar_images(
    ...
    try:
        ...
        results = collection.search(
            ...
            limit=top_k,
            expr=expr,
            output_fields=["input_prompt", "enhanced_prompt", "edited_prompt", 
                          "input_image_path", "output_image_path", "model_used", 
                          "category", "timestamp"]
        )
